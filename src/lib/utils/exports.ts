...
export async function exportToPPTX(
	...
	imageOption.style.backgroundColor =
		document.documentElement.classList.contains("dark") ? "#2d2d2d" : "#f9f9f9";
  ...
  `;
	...
	editableOption.style.backgroundColor =
		document.documentElement.classList.contains("dark") ? "#2d2d2d" : "#f9f9f9";
